# Generated by Django 2.2.15 on 2020-08-18 05:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.CharField(blank=True, help_text='unique asset ID', max_length=256, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('geometry', django.contrib.gis.db.models.fields.PolygonField(help_text='Geometry of Valve.', srid=4326)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.CharField(blank=True, help_text='unique asset ID', max_length=256, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('geometry', django.contrib.gis.db.models.fields.PolygonField(help_text='Geometry of Part.', srid=4326)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.CharField(blank=True, help_text='unique asset ID', max_length=256, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('geometry', django.contrib.gis.db.models.fields.PolygonField(help_text='Geometry of Chamber.', srid=4326)),
